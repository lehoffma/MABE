...
#ifndef MABE_DEFAULT_ARCHIVIST_H
#define MABE_DEFAULT_ARCHIVIST_H
...
public:
    ...
    DefaultArchivist(vector<string> popFileColumns, shared_ptr<Abstract_MTree> _maxFormula = nullptr,
                     shared_ptr<ParametersTable> _PT = nullptr, string _groupPrefix = "");
